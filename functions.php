...
function cleanalien_register_styles()
{
	...
	wp_enqueue_style('cleanalien-style', get_stylesheet_directory_uri() . "/style.css", array("cleanalien-bootstrap"), $version, 'all');
	wp_enqueue_style('cleanalien-bootstrap', get_stylesheet_directory_uri() . "/assets/src/library/css/bootstrap.css", array(),'5.0.2', 'all');
